...
// node_modules/@telekom/scale-components/dist/esm/scale-telekom-footer_2.entry.js
...
var TelekomFooterContent = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.logoHref = "javascript:void(0);";
  ...
  render() {
    ...
    }, transparent: true, href: this.logoHref, logoHideTitle: this.logoHideTitle, logoTitle: this.logoHideTitle ? void 0 : this.logoTitle })), h("div", { part: "body" }, h("div", { part: "notice" }, h("slot", { name: "notice" })), h("div", { part: "navigation" }, h("slot", { name: "navigation" }))))));
  }
};
TelekomFooterContent.style = telekomFooterContentCss;
export {
  TelekomFooter as scale_telekom_footer,
  TelekomFooterContent as scale_telekom_footer_content
};
//# sourceMappingURL=scale-telekom-footer_2.entry-CI3D4WH7.js.map
