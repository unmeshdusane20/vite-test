...
// node_modules/@telekom/scale-components/dist/esm/scale-badge_12.entry.js
...
var Badge = class {
  ...
  getAriaLabel() {
    const filledText = this.ariaLabelTranslation.replace(/\$count/g, `${this.count}`).replace(/\$label/g, `${this.label}`);
    return filledText;
  }
  render() {
    return h(Host, null, h("span", { part: "base", "aria-label": this.count ? this.getAriaLabel() : this.label }, h("slot", null), h("span", { "aria-hidden": "true", part: classnames(`circle`, this.count ? `has-count` : "no-count") }, !this.count ? "" : this.formatter.format(this.count)), h("span", { "aria-hidden": "true", id: "raw-count", part: "visually-hidden" }, this.count)), h("span", { id: "label", part: classnames("label", this.labelVisuallyHidden && "visually-hidden"), "aria-hidden": "true" }, this.label));
  }
  get hostElement() {
...
var TelekomMobileMenuItem = class {
  ...
  render() {
    ...
    }) }, h("slot", null), h("div", { part: "icon-right-container" }, !!this.children.length && !this.open && h("scale-icon-navigation-right", { size: 20, color: this.active ? "var(--telekom-color-primary-standard)" : "var(--telekom-color-text-and-icon-standard)" }))), h("slot", { name: "children" })));
  }
  get hostElement() {
    return getElement(this);
  }
...
export {
  Badge as scale_badge,
  ActionMenu as scale_icon_action_menu,
  UserFileUser as scale_icon_user_file_user,
  TelekomHeader as scale_telekom_header,
  TelekomMegaMenu as scale_telekom_mega_menu,
  TelekomMegaMenuColumn as scale_telekom_mega_menu_column,
  TelekomMobileFlyoutCanvas as scale_telekom_mobile_flyout_canvas,
  TelekomMobileMenu as scale_telekom_mobile_menu,
  TelekomMobileMenuItem as scale_telekom_mobile_menu_item,
  TelekomNavItem$1 as scale_telekom_nav_flyout,
  TelekomNavItem as scale_telekom_nav_item,
  TelekomNavList as scale_telekom_nav_list
};
//# sourceMappingURL=scale-badge_12.entry-DJS6UMRN.js.map
