...
// node_modules/@telekom/scale-components/dist/esm/scale-carousel.entry.js
...
var Carousel = class {
  constructor(hostRef) {
    ...
    this.handleSlideChange = (direction) => {
      ...
      if (direction === "prev") {
        val === 0 ? this.value = -100 * (this.slidesArray.length - 1) : this.value = val + 100;
      }
      if (direction === "next") {
        val === -100 * (this.slidesArray.length - 1) ? this.value = 0 : this.value = val - 100;
      }
    };
...
export {
  Carousel as scale_carousel
};
//# sourceMappingURL=scale-carousel.entry-UJMZ53MG.js.map
