...
// node_modules/@telekom/scale-components/dist/esm/duet-date-picker_2.entry.js
...
var DatePickerInput = ({ onClick, dateFormatter, localization: localization2, name, formattedValue, valueAsDate, value, identifier, disabled, required, role, buttonRef, inputRef, onInput, onBlur, onFocus }) => {
  return h(
    ...
    h("input", { class: "duet-date__input", value: formattedValue, placeholder: localization2.placeholder, id: identifier, disabled, role, required: required ? true : void 0, "aria-autocomplete": "none", onInput, onFocus, onBlur, autoComplete: "off", ref: inputRef }),
...
var DatePickerMonth = ({ selectedDate, focusedDate, labelledById, localization: localization2, firstDayOfWeek, min, max, dateFormatter, onDateSelect, onKeyboardNavigation, focusedDayRef }) => {
  ...
  return h(
    ...
    h(
      "thead",
      null,
      h("tr", null, mapWithOffset(localization2.dayNames, firstDayOfWeek, (dayName) => h(
        "th",
    ...
    h("tbody", null, chunk(days, 7).map((week) => h("tr", { class: "duet-date__row" }, week.map((day) => h(
      "td",
      { class: "duet-date__cell" },
      h(DatePickerDay, { day, today, focusedDay: focusedDate, isSelected: isEqual(day, selectedDate), inRange: inRange(day, min, max), onDaySelect: onDateSelect, dateFormatter, onKeyboardNavigation, focusedDayRef })
    )))))
  );
};
var localization = {
...
export {
  DuetDatePicker as duet_date_picker,
  ContentCalendar as scale_icon_content_calendar
};
//# sourceMappingURL=duet-date-picker_2.entry-L7GJJAWV.js.map
